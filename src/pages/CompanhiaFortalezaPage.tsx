      ...
      <div className="flex-1 lg:ml-64 transition-all duration-300 p-4 lg:p-8">
        <div className="w-full">
            ...
            <div className="flex flex-col gap-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm lg:text-lg">Análise financeira detalhada da unidade Fortaleza</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Próximas Ações */}
            <NextActions empresa="Companhia do Churrasco - Fortaleza" />
          </div>
        </div>
      </div>
...
export default CompanhiaFortalezaPage;
